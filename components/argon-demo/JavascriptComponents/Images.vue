<template>
    <div class="row">
        <div class="col-sm-3 col-6">
            ...
            <img v-lazy="'/argon/img/theme/team-1-800x800.jpg'" alt="Rounded image" class="img-fluid rounded shadow"
                 style="width: 150px;">
        </div>
        <div class="col-sm-3 col-6">
        ...
        <div class="col-sm-3 col-6 mt-5 mt-sm-0">
            ...
            <img v-lazy="'/argon/img/theme/team-3-800x800.jpg'" alt="Raised image" class="img-fluid rounded shadow-lg"
                 style="width: 150px;">
        </div>
        <div class="col-sm-3 col-6 mt-5 mt-sm-0">
